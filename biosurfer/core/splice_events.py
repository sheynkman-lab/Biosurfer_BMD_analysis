...
def call_transcript_events(anchor: 'Transcript', other: 'Transcript'):
    ...
    print("Anchor tx start and stop:", anchor, anchor_start, anchor_stop)
    print("Other tx start and stop:", other, other_start, other_stop)

    upstream_stop = max(anchor_start, other_start)
    downstream_start = min(anchor_stop, other_stop)

    print("Upstream start and stop:", downstream_start, upstream_stop)
    print("Anchor junctions", set(anchor.junctions))
    print("Printing other", other.junctions)
